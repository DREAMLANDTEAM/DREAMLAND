...
SUDO = SUDO
sudo_users = {SUDO,1511604535,1265597761}   
print([[
> CH › @hi_z2
> CH › @H_U_O_L
~> DEVELOPER › @hi_z4
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DREAMLANDTEAM/Files_DREAMLAND/main/File_Bot/commands.lua") 
...
function DREAMLANDSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDREAMLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1511604535) then  
var = true  
elseif tonumber(user_id) == tonumber(1265597761) then
var = true  
...
local UserName = (data.username_ or "hi_z2")
...
local DREAMLAND_Msg = ''  
if msgs < 100 then 
DREAMLAND_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
DREAMLAND_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
DREAMLAND_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
DREAMLAND_Msg = 'متفاعل' 
elseif msgs < 1200 then 
DREAMLAND_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
DREAMLAND_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
DREAMLAND_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
DREAMLAND_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
DREAMLAND_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DREAMLAND_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DREAMLAND_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DREAMLAND_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
DREAMLAND_Msg = 'رب التفاعل'  
end 
return DREAMLAND_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@hi_z4")  
...
--------------------------------------------------------------------------------------------------------------
function SourceDREAMLAND(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if start then 
SourceDREAMLANDr = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'دريم لاند')
SourceDREAMLANDr = '*✫︙اهلا عزيزي*\n*✫︙انا بوت اسمي '..Namot..'*\n*✫︙اختصاصي حمايه الكروبات*\n*✫︙من تكرار والسبام والتوجيه والخ…*\n*✫︙لتفعيلي اتبع الاخطوات…↓*\n*✫︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n✫︙[قناة سورس البوت](http://t.me/hi_z2)'
end
send(msg.chat_id_, msg.id_, SourceDREAMLANDr) 
end
end
...
local list = database:smembers(bot_id.."DREAMLAND1:List:Filter"..sl)
...
if not DevDREAMLANDW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevDREAMLANDW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,DREAMLAND_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✫' and DevDREAMLANDW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevDREAMLANDW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevDREAMLANDW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevDREAMLANDW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevDREAMLANDW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✫︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevDREAMLANDW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✫︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and DevDREAMLANDW(msg) then 
...
if text == 'تحديث السورس ✫' and DevDREAMLANDW(msg) then 
os.execute('rm -rf DREAMLAND.lua')
os.execute('wget https://raw.githubusercontent.com/DREAMLANDTEAM/DREAMLAND/main/DREAMLAND.lua')
send(msg.chat_id_, msg.id_,' *✫︙تم تحديث السورس* \n*✫︙لديك اخر اصدار لسورس دريم لاند*\n*✫︙الاصدار » { 2.8v}*')
dofile('DREAMLAND.lua')  
end
if text == 'الاصدار ✫' and DevDREAMLANDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✫︙اصدار سورس دريم لاند* \n*✫︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and DevDREAMLANDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫︙[تحديثات البوت](t.me/H_U_O_L) \n✫︙[قناه السورس](t.me/hi_z2)')
end
if text == "ضع اسم للبوت ✫" and DevDREAMLANDW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and DevDREAMLANDW(msg) then 
...
if text == 'المشتركين ✫' and DevDREAMLANDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and DevDREAMLANDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and DevDREAMLANDW(msg) then
...
if text == ("قائمه العام ✫") and DevDREAMLANDW(msg) then
...
if text == ("قائمه الكتم العام ✫") and DevDREAMLANDW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevDREAMLANDW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevDREAMLANDW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevDREAMLANDW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevDREAMLANDW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevDREAMLANDW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and DevDREAMLANDW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and DevDREAMLANDW(msg) then
...
if text == "تنظيف الكروبات ✫" and DevDREAMLANDW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✫︙عدد الكروبات الان » { '..#group..' }'..DREAMLANDk..''..DREAMLAND..'*\n*✫︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevDREAMLANDW(msg) then
...
usertext = '*\n ✫︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'hi_z2')..')'
status  = '\n *✫︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevDREAMLANDW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✫︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
status  = '\n*✫︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevDREAMLANDW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevDREAMLANDW(msg) then
...
local DREAMLAND1_Msg = database:get(bot_id.."DREAMLAND1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DREAMLAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'hi_z2')..') \n ✫︙'..DREAMLAND1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DREAMLAND_Msg and not Special(msg) then  
local DREAMLAND_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DREAMLAND_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫︙["..DREAMLAND_Msg.."] \n")
else
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/hi_z2)}\n✫︙["..DREAMLAND_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✫︙عذرا ↫* {["..data.first_name_.."](T.ME/hi_z2)}\n*✫︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevDREAMLANDW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevDREAMLANDW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevDREAMLANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevDREAMLANDW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevDREAMLANDW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✫︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevDREAMLANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevDREAMLANDW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevDREAMLANDW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✫︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevDREAMLANDW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."DREAMLAND:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DREAMLAND:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_DREAMLAND = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_DREAMLAND then 
names_DREAMLAND = database:smembers(bot_id.."DREAMLAND:blocname"..msg.chat_id_) or ""
if names_DREAMLAND and names_DREAMLAND[1] then 
for i=1,#names_DREAMLAND do 
if name_DREAMLAND:match("(.*)("..names_DREAMLAND[i]..")(.*)") then 
...
database:set(bot_id.."DREAMLAND:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DREAMLAND:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DREAMLAND:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DREAMLAND:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DREAMLAND:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_DREAMLANDa_new(DREAMLAND1,DREAMLAND2)
if DREAMLAND2 and DREAMLAND2.first_name_ then 
if DREAMLAND2.first_name_:match("(.*)"..database:get(bot_id.."DREAMLAND:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DREAMLAND:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local DREAMLAND_nnn = database:get(bot_id.."DREAMLAND:nump"..msg.chat_id_) or 5
local DREAMLAND_nnn2 = database:get(bot_id.."DREAMLAND:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(DREAMLAND_nnn2) == tonumber(DREAMLAND_nnn) or tonumber(DREAMLAND_nnn2) > tonumber(DREAMLAND_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DREAMLAND:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫︙عزيزي >>["..DREAMLAND2.username_.."](https://t.me/"..(DREAMLAND2.username_ or "hi_z2")..")\n✫︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DREAMLAND:teh"..msg.chat_id_).."} بجانب اسمك\n✫︙عدد المحاولات المتبقيه {"..(tonumber(DREAMLAND_nnn) - tonumber(DREAMLAND_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_DREAMLANDa_new)
end
end
...
local DREAMLANDChengName = database:get(bot_id.."DREAMLAND:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DREAMLANDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DREAMLANDChengName..']')
database:del(bot_id.."DREAMLAND:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DREAMLANDChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DREAMLAND:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DREAMLANDChengUserName = database:get(bot_id.."DREAMLAND:Cheng:UserName"..data.id_)
if not data.username_ then 
if DREAMLANDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DREAMLANDChengUserName..']')
database:del(bot_id.."DREAMLAND:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DREAMLANDChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DREAMLAND:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DREAMLANDChengPhoto = database:get(bot_id.."DREAMLAND:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DREAMLANDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DREAMLAND:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DREAMLANDChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DREAMLAND:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴅʀᴇᴀᴍʟᴀɴᴅ\n\n[✫  ᴅʀᴇᴀᴍʟᴀɴᴅ ᴄʜᴀɴɴᴇʟ](http://t.me/H_U_O_L)\n\n[✫  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/hi_z2)\n\n[✫  ᴅʀᴇᴀᴍʟᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/hi_z4)\n\n[✫  ʙᴏᴛ ᴅʀᴇᴀᴍʟᴀɴᴅ](http://t.me/crystalh_bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫ sᴏᴜʀᴄʀ ᴅʀᴇᴀᴍʟᴀɴᴅ',url="t.me/H_U_O_L/3374"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hi_z2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevDREAMLANDW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✫︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'hi_z2')..') \n*✫︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'hi_z2')..') \n*✫︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevDREAMLANDW(msg) then
dofile('DREAMLAND.lua')  
send(msg.chat_id_, msg.id_, ' *✫︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevDREAMLANDW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevDREAMLANDW(msg) then  
function start_function(extra, result, success)
if DREAMLANDSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevDREAMLANDW(msg) then  
...
if DREAMLANDSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✫︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevDREAMLANDW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if DREAMLANDSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✫︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevDREAMLANDW(msg) then  
function start_function(extra, result, success)
if DREAMLANDSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✫︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevDREAMLANDW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevDREAMLANDW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if DREAMLANDSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✫︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevDREAMLANDW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevDREAMLANDW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevDREAMLANDW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevDREAMLANDW(msg) then
...
if text == 'الملفات' and DevDREAMLANDW(msg) then
t = ' *✫︙ملفات السورس دريم لاند ↓*\n*•━━━━━━ 𝘿𝙇 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevDREAMLANDW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DREAMLANDTEAM/Files_DREAMLAND/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✫︙اهلا بك في متجر ملفات دريم لاند*\n*✫︙ملفات السورس ↓*\n*•━━━━━━ 𝘿𝙇 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝘿𝙇 ━━━━━━━•*\n *✫︙علامة تعني { ✓ } ملف مفعل*\n *✫︙علامة تعني { ✘ } ملف معطل*\n *✫︙قناة سورس دريم لاند ↓*\n".." *✫︙*[اضغط هنا لدخول](t.me/hi_z2) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevDREAMLANDW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DREAMLANDTEAM/Files_DREAMLAND/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DREAMLAND.lua')  
else
send(msg.chat_id_, msg.id_," *✫︙عذرا الملف لايدعم سورس دريم لاند* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevDREAMLANDW(msg) then
...
if text == "مسح الملفات" and DevDREAMLANDW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✫︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevDREAMLANDW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevDREAMLANDW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "hi_z2")
...
function Function_DREAMLAND(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DREAMLAND, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DREAMLAND, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
status  = '\n*✫︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✫︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
status  = '\n*✫︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✫︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
...
database:set(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DREAMLAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DREAMLAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DREAMLAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DREAMLAND1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DREAMLAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✫︙ارسل الكلمه الان*")  
database:set(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DREAMLAND1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DREAMLAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DREAMLAND1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DREAMLAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DREAMLAND1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DREAMLAND1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevDREAMLANDW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✫︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevDREAMLANDW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✫︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'hi_z2')..')'..'\n*✫︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevDREAMLANDW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevDREAMLANDW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دريم لاند').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دريم لاند')
local DREAMLAND_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..DREAMLAND_Msg[math.random(#DREAMLAND_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevDREAMLANDW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,DREAMLAND)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝘿𝙇 ━━━━━━━•*\n"
x = 0
local list = DREAMLAND.members_
for k, v in pairs(list) do
x = x + 1
...
if DREAMLANDSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevDREAMLANDW(msg) then 
...
if text == ("ردود المطور") and DevDREAMLANDW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✫︙قائمة ردود المطور \n*•━━━━━━ 𝘿𝙇 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevDREAMLANDW(msg) then    
send(msg.chat_id_, msg.id_,' *✫︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevDREAMLANDW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دريم لاند').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevDREAMLANDW(msg) then   
...
if text == 'تعطيل المغادره' and DevDREAMLANDW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✫︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'H_U_O_L')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
DREAMLANDdx(msg.chat_id_, msg.id_, ' *✫︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✫︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✫︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✫︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevDREAMLANDW(msg) then
...
{{text = '𝐷𝑅𝐸𝐴𝑀 𝐿𝐴𝑁𝐷 𖢌', url="t.me/H_U_O_L"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝐷𝑅𝐸𝐴𝑀 𝐿𝐴𝑁𝐷 𖢌', url="t.me/H_U_O_L"}},
{{text = 'مطور السورس', url="t.me/hi_z4"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━━━━ 𝘿𝙇 ━━━━━━━•*ٴ✫∫○ٴ\n✫︙[𝐷𝑅𝐸𝐴𝑀 𝐿𝐴𝑁𝐷 𖢌](t.me/hi_z2) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴅʀᴇᴀᴍʟᴀɴᴅ',url='http://t.me/H_U_O_L'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'دريم لاند')
...
DREAMLAND = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DREAMLAND)
...
--------------------------------------------------------------------------------------------------------------
SourceDREAMLAND(data.message_,data)
...
------------------------------------------------------------------------
local DREAMLANDAbot = database:get(bot_id.."DREAMLAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if DREAMLANDAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫︙["..DREAMLANDAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local DREAMLAND1_Msg = database:get(bot_id.."DREAMLAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if DREAMLAND1_Msg then
send(msg.chat_id_, msg.id_," ✫︙"..DREAMLAND1_Msg)
