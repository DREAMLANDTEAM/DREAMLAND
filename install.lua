...
local RunBot = io.open("DREAMLAND", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/DREAMLAND
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr DREAMLAND.lua
wget "https://raw.githubusercontent.com/DREAMLANDTEAM/DREAMLAND/main/DREAMLAND.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./DREAMLAND.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S DREAMLAND -X kill
screen -S DREAMLAND ./DREAMLAND
done
]])
RunTs:close()
end
